...
package com.example.computer.mlkitcodelab;
...
import com.example.computer.mlkitcodelab.GraphicOverlay;
import com.example.computer.mlkitcodelab.GraphicOverlay.Graphic;
...
public class MainActivity extends AppCompatActivity implements AdapterView.OnItemSelectedListener {
    ...
    private void runFaceContourDetection() {
        ...
        detector.detectInImage(image).addOnSuccessListener(new OnSuccessListener<List<FirebaseVisionFace>>() {
            ...
            public void onSuccess(List<FirebaseVisionFace> firebaseVisionFaces) {
                ...
                processFaceContourDetectionResult(firebaseVisionFaces);
            }
        }).addOnFailureListener(new OnFailureListener() {
            @Override
            public void onFailure(@NonNull Exception e) {
    ...
    private void processFaceContourDetectionResult(List<FirebaseVisionFace> faces) {
        ...
        for (int i = 0; i < faces.size(); ++i) {
            ...
            faceContourGraphic.updateFace(firebaseVisionFace);
        }
    }
